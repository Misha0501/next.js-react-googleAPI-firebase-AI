...
test.beforeEach(async ({ page }) => {
  ...
  const targetUrl =
    (process.env.ENVIRONMENT_URL
      ? process.env.ENVIRONMENT_URL + "/listings"
      : undefined) || "http://localhost:3000/listings";
  ...
  const minMaxFiltersConfigs = [
    {
      paramName: "priceMin",
      value: 50000,
      locator: "#priceFilterMin",
      description: "min price filter",
    },
    {
      paramName: "priceMax",
      value: 75000,
      locator: "#priceFilterMax",
      description: "max price filter",
    },
    {
      paramName: "areaLivingMin",
      value: 50,
      locator: "#livingAreaRangeFilterMin",
      description: "min living area range filter",
    },
    {
      paramName: "areaLivingMax",
      value: 75,
      locator: "#livingAreaRangeFilterMax",
      description: "max living area range filter",
    },
    {
      paramName: "areaTotalMin",
      value: 100,
      locator: "#areaTotalFilterMin",
      description: "min total area range filter",
    },
    {
      paramName: "areaTotalMax",
      value: 150,
      locator: "#areaTotalFilterMax",
      description: "max total area range filter",
    },
    {
      paramName: "roomsMin",
      value: 1,
      locator: "#roomRangeFilterMin",
      description: "min rooms range filter",
    },
    {
      paramName: "roomsMax",
      value: 2,
      locator: "#roomRangeFilterMax",
      description: "max rooms range filter",
    },
    {
      paramName: "bedroomsMin",
      value: 1,
      locator: "#bedroomRangeFilterMin",
      description: "min bedrooms range filter",
    },
    {
      paramName: "bedroomsMax",
      value: 2,
      locator: "#bedroomRangeFilterMax",
      description: "max bedrooms range filter",
    },
  ];

  for (const config of minMaxFiltersConfigs) {
    test(config.description, async ({ page }: { page: Page }) => {
      await testMinMaxxFilter(
        config.paramName,
        config.value,
        config.locator,
        page,
...
test.describe("Radio button filter values should trigger a change url and a request once selected for", () => {
  const radioConfigs = [
    {
      queryParam: "listedSince",
      value: "0",
      locator: 'input[id="listedSinceFilter0"]',
      description: "No preference",
    },
    {
      queryParam: "listedSince",
      value: "1",
      locator: 'input[id="listedSinceFilter1"]',
      description: "Last 24 hours",
    },
    {
      queryParam: "listedSince",
      value: "3",
      locator: 'input[id="listedSinceFilter2"]',
      description: "3 days",
    },
    {
      queryParam: "listedSince",
      value: "7",
      locator: 'input[id="listedSinceFilter3"]',
      description: "7 days",
    },
    {
      queryParam: "listedSince",
      value: "10",
      locator: 'input[id="listedSinceFilter4"]',
      description: "10 days",
    },
    {
      queryParam: "listedSince",
      value: "30",
      locator: 'input[id="listedSinceFilter5"]',
      description: "30 days",
    },
  ];

  for (const config of radioConfigs) {
    test(`listed since filter: ${config.description}`, async ({
      page,
    }: {
      page: Page;
    }) => {
      await testRadioSelection(
        config.queryParam,
        config.value,
        "#listedSinceFilter",
        config.locator,
  ...
  const checkboxConfigs = [
    {
      ...
      value: "HOUSE",
      locator: 'input[id="propertyTypeFilterHOUSE"]',
      description: "House",
    },
    {
      queryParam: "propertyType",
      value: "APARTMENT",
      locator: 'input[id="propertyTypeFilterAPARTMENT"]',
      description: "Apartment",
    },
    {
      queryParam: "propertyType",
      value: "APARTMENT",
      locator: 'input[id="propertyTypeFilterPARKING"]',
      description: "Parking",
    },
    {
      queryParam: "propertyType",
      value: "APARTMENT",
      locator: 'input[id="propertyTypeFilterLAND"]',
      description: "Land",
    },
  ];
...
const testMinMaxxFilter = async (
  ...
  await page.route(
    `**/listings**${filterQueryParam}=${expectedValue}**`,
    (route) => {
      requestMade = true;
      route.continue();
    },
  ...
  const selectedValue = await filterLocator
    .locator("button span:first-of-type")
    .innerText();
...
const testCheckboxSelection = async (
  ...
  const isSelected = await page
    .locator(`${parentComponentId} ${checkboxLocatorId}`)
    .isChecked();
  expect(isSelected).toBe(true);
};
