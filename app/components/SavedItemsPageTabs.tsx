...
export const SavedItemsPageTabs = () => {
    ...
    const handleTabChange = (tabIndex: number) => {console.log("Tab changed")}
                            ...
                            {!isLoading && !error && <div>
                                <div className="flex justify-between items-baseline">
                                    ...
                                    <div className="flex gap-7">
                                        ...
                                        <div>
                                            <Select defaultValue={sortingBySelected} onValueChange={setSortingBySelected}
                                ...
                                <div className={"grid grid-cols-3 gap-16 mt-10"}>
                                    {savedListings && savedListings.map((item, index) => (
                                        <ListingItem listingItem={item.listing} key={index}/>
                                    ))}
                                </div>
                            </div>}
                        </div>
