          ...
          <div className="relative hidden min-h-[660px] overflow-hidden lg:block">
            ...
            <div className="absolute inset-x-0 bottom-0 p-10 text-white">
              ...
              <p className="mt-4 max-w-md text-base leading-7 text-white/80">
                {mode === "signin"
                  ? "Sign in to continue saving homes, managing properties, and working with your property activity in one place."
            ...
            <div className="mx-auto w-full max-w-[440px]">
              <div className="mb-8">
                ...
                <p className="mt-4 text-base leading-7 text-slate-600">
                  {mode === "signin"
                    ? "Access saved properties, property tools, and your profile."
                    : "Join Homfli to place properties, save homes, and more."}
                </p>
              </div>
