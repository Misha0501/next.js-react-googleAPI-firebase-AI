...
export const PlacePropertyForm = ({label, checked, onChange, name}) => {
    ...
    const [administrativeAreaLevelOne, setAdministrativeAreaLevelOne] = useState('')
    const [postalCode, setPostalCode] = useState('')
    const [neighborhood, setNeighborhood] = useState('')
    const [latitude, setLatitude] = useState('')
    const [longitude, setLongitude] = useState('')
    const [example, setExample] = useState('ul. "Sofia" 2, Ruse, Bulgaria')
    const [showFullAdress, setShowFullAdress] = useState(false)
    ...
    return (
        <div className="">
            <h3 className={"text-4xl font-bold max-w-xl mb-12"}>Add essential information about your
                company</h3>
            <div className="grid grid-cols-2 gap-16">
                <p className={"text-2xl font-bold"}>Are you planning to rent or sell your property?</p>
                <Tab.Group selectedIndex={listingTypeSelectedIndex} onChange={setListingTypeSelectedIndex}>
                    <Tab.List
                        className="flex space-x-1 rounded-xl bg-blue-900/20 p-1 mb-5 w-full text-black">
                        <Tab
                            className={({selected}) =>
                                classNames(
            ...
            <Divider></Divider>
            <div className="grid grid-cols-2 gap-16">
                <p className={"text-2xl font-bold"}>What is the location of your property</p>
                <div className="">
                    <div className="mb-7">
                    ...
                    {showFullAdress && <div className="">
                        ...
                        <div className="mb-7">
                            ...
                            <TextInput value={route} onChange={(e) => setRoute(e.target.value)}/>
                        </div>
                        <div className="mb-7">
                        ...
                        <div className="mb-7">
                            ...
                            <TextInput value={administrativeAreaLevelOne}
                                       onChange={(e) => setAdministrativeAreaLevelOne(e.target.value)}/>
                        </div>
                        <div className="mb-7">
                        ...
                        <div className="mb-7">
                            ...
                            <TextInput value={latitude} onChange={(e) => setPostalCode(e.target.value)}/>
                        </div>
                        <div className="mb-7">
                            <p className={"mb-2"}>Longitude</p>
                            <TextInput value={longitude} onChange={(e) => setPostalCode(e.target.value)}/>
                        </div>
                    </div>}
