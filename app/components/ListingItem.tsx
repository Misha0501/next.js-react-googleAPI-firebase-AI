...
export const ListingItem = ({ listingItemInitial, onSavedIconClick, isLoadingSavedListings = false, ownerView, onDeleteIconClick, onStateChanged, isLoading }: ListingItemProps) => {
                  ...
                  {listingItem.areaTotal &&
                    ...
                    listingItem.currency && (
                      <span className={"text-gray-500 font-semibold"}>
                        {roundToTwo(listingItem.price / listingItem.areaTotal)}{" "}
                        {getCurrencySign(listingItem.currency)} / &#13217;
                      </span>
                    )}
                </>
