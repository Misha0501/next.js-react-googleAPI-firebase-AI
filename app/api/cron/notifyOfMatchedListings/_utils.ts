    ...
    const matchedSearches = savedSearches.filter((search: SavedSearch) => {
      return (
        ...
        (!search.areaTotalMin ||
          ...
          search.areaTotalMin <= listing.areaTotal) &&
        (!search.areaTotalMax ||
          listing.areaTotal == null ||
          search.areaTotalMax >= listing.areaTotal) &&
        (!search.areaLivingMin ||
          listing.areaLiving == null ||
          search.areaLivingMin <= listing.areaLiving) &&
        (!search.areaLivingMax ||
          listing.areaLiving == null ||
          search.areaLivingMax >= listing.areaLiving) &&
        (!search.areaLandMin ||
          listing.areaLand == null ||
          search.areaLandMin <= listing.areaLand) &&
        (!search.areaLandMax ||
          listing.areaLand == null ||
          search.areaLandMax >= listing.areaLand) &&
        (!search.upkeepType ||
          !search.upkeepType.length ||
          (listing.upkeepType != null &&
            search.upkeepType.includes(listing.upkeepType))) &&
        (!search.interiorType ||
          !search.interiorType.length ||
          (listing.interiorType != null &&
        ...
        (!search.heatingType ||
          ...
          (listing.heatingType != null &&
            search.heatingType.includes(listing.heatingType))) &&
        (!search.roomsMin ||
          listing.rooms == null ||
          search.roomsMin <= listing.rooms) &&
        (!search.roomsMax ||
          listing.rooms == null ||
          search.roomsMax >= listing.rooms) &&
        (!search.bedroomsMin ||
          listing.bedrooms == null ||
          search.bedroomsMin <= listing.bedrooms) &&
        (!search.bedroomsMax ||
          listing.bedrooms == null ||
          search.bedroomsMax >= listing.bedrooms) &&
        (!search.constructedYearMin ||
          listing.constructedYear == null ||
        ...
        (!search.bathroomsMin ||
          ...
          search.bathroomsMin <= listing.bathrooms) &&
        (!search.bathroomsMax ||
          listing.bathrooms == null ||
          search.bathroomsMax >= listing.bathrooms) &&
        (!search.areaOutsideMin ||
          listing.areaOutside == null ||
